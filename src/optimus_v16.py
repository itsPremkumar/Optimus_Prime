...
LOG_FILE       = os.path.join(LOG_DIR,  f"optimus_v16_{_ts}.txt")
BOM_FILE       = os.path.join(_OUT,     f"BOM_v16_{_ts}.csv")
ASSEMBLY_FILE  = os.path.join(_OUT,     f"ASSEMBLY_GUIDE_v16_{_ts}.txt")
MANIFEST_FILE  = os.path.join(_OUT,     f"BUILD_MANIFEST_v16_{_ts}.json")
PRODUCTION_FILE= os.path.join(_OUT,     f"PRODUCTION_v16_{_ts}.txt")
...
class DebugManager:
    ...
    def _global_exception_handler(cls, exc_type, exc_value, exc_traceback):
        ...
        try:
            dump_path = os.path.join(_OUT, "CRASH_DUMP_v16.json")
    ...
    def generate_debug_report(cls):
        ...
        report_path = os.path.join(_OUT, f"OPTIMUS_DEBUG_REPORT_v16.txt")
        try:
...
def run(context):
    ...
    Logger.log("=" * 64)
    Logger.log("EXECUTION START  v16.0 -- Optimus Prime G1 Unified Distributed AI Edition")
    ...
    try:
        ...
        def write_assembly_guide():
            try:
                ...
                with open(ASSEMBLY_FILE, "w", encoding="utf-8") as f:
                    f.write("=" * 64 + "\n")
                    f.write("  OPTIMUS PRIME G1 v16.0  ASSEMBLY GUIDE\n")
        ...
        def write_production_readiness_report(check_rows=None):
            ...
            try:
                ...
                with open(PRODUCTION_FILE, "w", encoding="utf-8") as f:
                    f.write("OPTIMUS PRIME G1 v16.0 PRODUCTION READINESS\n")
                    f.write("Jetson Nano AI Brain Edition\n")
                    f.write("=" * 56 + "\n\n")
        ...
        class SimulationEngine:
            ...
            def simulate_robot_mode(self):
                ...
                try:
                    ...
                    pass
                self.capture_screenshots("optimus_robot_v16")
            ...
            def simulate_truck_mode(self):
                ...
                try:
                    ...
                    pass
                self.capture_screenshots("optimus_truck_v16")
            ...
            def simulate_battle_mode(self):
                ...
                self.capture_screenshots("optimus_battle_v16")
            ...
            def export_urdf(self):
                ...
                try:
                    ...
                    path = os.path.join(EXPORT_DIR, "robot_v16.urdf")
                    jc   = self._root.asBuiltJoints.count
                    with open(path, "w", encoding="utf-8") as f:
                        f.write('<?xml version="1.0" encoding="utf-8"?>\n')
                        f.write('<robot name="Optimus_Prime_G1_v16">\n\n')
                        for comp in self._comps:
            ...
            def export_step(self):
                try:
                    os.makedirs(EXPORT_DIR, exist_ok=True)
                    export_mgr = self._design.exportManager
                    path = os.path.join(EXPORT_DIR, "Optimus_Prime_G1_v16.step")
            ...
            def run_all_simulations(self):
                ...
                Logger.log("=" * 58)
                Logger.log("OPTIMUS PRIME G1 v16.0 -- FINAL REPORT")
                ...
                if EXPORT_URDF:
                    Logger.log(f"  URDF  -> {EXPORT_DIR}/robot_v16.urdf")
                ...
                Logger.log("=" * 58)
                Logger.log("v16 BUILD COMPLETE -- Review ASSEMBLY_GUIDE before printing")
        ...
        try:
            os.makedirs(EXPORT_DIR, exist_ok=True)
            archive_path = os.path.join(EXPORT_DIR, "Optimus_Prime_G1_v16.f3d")
        ...
        Logger.log("v16 script finished successfully.")
